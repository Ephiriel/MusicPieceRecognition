...
"}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("ui/save-as.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_save_query.setIcon(icon9)
        self.action_save_query.setObjectName("action_save_query")
        self.action_load_query = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("ui/music.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_load_query.setIcon(icon10)
        self.action_load_query.setObjectName("action_load_query")
        self.action_load_database = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("ui/database.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_load_database.setIcon(icon11)
        self.action_load_database.setObjectName("action_load_database")
        self.action_open_database = QtWidgets.QAction(MainWindow)
        self.action_open_database.setIcon(icon11)
        self.action_open_database.setObjectName("action_open_database")
        self.action_open_query = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("ui/open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_open_query.setIcon(icon12)
