...
class Ui_LoadingLibrary(object):
    def setupUi(self, LoadingLibrary):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("gui/icons/database.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap("gui/icons/database.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
